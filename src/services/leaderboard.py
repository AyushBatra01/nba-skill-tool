...
from src.scoring.scoring import build_skill_table, build_full_table
from src.scoring.configs import configs, pillar_views
...
def get_skill_leaderboard(season, skill, minimum=500):
    ...
    df = build_skill_table(season, configs, skill, minimum)
